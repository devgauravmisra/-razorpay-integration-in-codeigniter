...
$card_holder_name = 'Gaurav mishra';
$email = 'gauravmisra47@gmail.com';
$phone = '9044789347';
  ...
  <input type="hidden" name="merchant_amount" id="merchant_amount" value="<?php echo $amount; ?>"/>
    ...
    <div class="row"  style="text-align: center !important;">   
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >                        
            <table class="table table-bordered table-hover table-striped print-table order-table " style="font-size:11px; align:center; ">
